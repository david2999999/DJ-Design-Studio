...
app.get("/TWDB/Mountain-Travel",function(req, res){
...
app.get("/maplestory/news",function(req, res) {
    res.render("MapleStory/newshub");
});

app.get("/maplestory/updates",function(req, res) {
...
app.get("/maplestory/exploreMS",function(req, res) {
    res.render("MapleStory/explore-maple");
});
